    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-400 to-indigo-500">
      <div className="flex w-full h-screen bg-gray-50">
        ...
        <div className="flex-1 flex flex-col bg-gray-50">
            ...
            <div className="flex justify-between items-center gap-3">
              ...
              <div className="flex items-center gap-3">
                ...
                >
                  ...
                  <div className="flex flex-col">
                    <div className="font-bold text-gray-900 text-xs">Konan Patrick</div>
                    <div className="text-blue-500 text-[9px] font-semibold">Locataire</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          {/* Content Area - Vide pour les appels de pages */}
